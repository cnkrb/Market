...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        try {
            ...
            if(getGroup(groupPosition).menuName.equals("Mağaza Değiştir")){
                go.setImageResource(R.drawable.go);
                go.setPadding(15,15,15,15);
            }
            if(getGroup(groupPosition).menuName.equals("İndirimler")){
                go.setImageResource(R.drawable.go);
                go.setPadding(15,15,15,15);
            }
            if(getGroup(groupPosition).menuName.equals("Kampanyalar")){
                go.setImageResource(R.drawable.go);
                go.setPadding(15,15,15,15);
            }
            ...
            if(getGroup(groupPosition).menuName.equals("Siparişler")  || getGroup(groupPosition).menuName.equals("Mağaza Hakkında") || getGroup(groupPosition).menuName.equals("Ana Sayfa") ){
                go.setImageResource(R.drawable.go);
                if(getGroup(groupPosition).menuName.equals("Siparişler")){
                    lblListHeader_image.setImageResource(R.drawable.food);
                }else if(getGroup(groupPosition).menuName.equals("Mağaza Hakkında")) {
                    lblListHeader_image.setImageResource(R.drawable.changestore);
                }else {
                    lblListHeader_image.setImageResource(R.drawable.changestore);
                }
                go.setPadding(15,15,15,15);
            }else {
                System.out.println("http://market.cenkkaraboa.com/public/images/katagori/"+getGroup(groupPosition).image+"dadaddddadada");
                Picasso.with(context).load("https://market.cenkkaraboa.com/public/images/katagori/"+getGroup(groupPosition).image).into(lblListHeader_image);
            }
            ...
            if(getGroup(groupPosition).menuName.equals("Kategoriler")){
                go.setVisibility(View.GONE);
                lblListHeader_image.setVisibility(View.GONE);
                lblListHeader.setTextSize(18);
                linear.setBackgroundColor(context.getResources().getColor(R.color.light_color));
